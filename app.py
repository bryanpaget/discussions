...
ORIGINAL_CONVERSATION = {"id": {"gitlab_comment_id": "", "name": "", "comment": ""}}
KLD = {"id": {"name": "", "comment": ""}}
LSA = {"id": {"name": "", "comment": ""}}
TEXTRANK = {"id": {"name": "", "comment": ""}}
LEXRANK = {"id": {"name": "", "comment": ""}}
SPACY = {"id": {"name": "", "comment": ""}}
...
async def summarize(request):
    ...
    summarizer = Summarizer(project_id=project_id, issue_id=issue_id)
